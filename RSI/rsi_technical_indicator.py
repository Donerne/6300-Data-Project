...
for stock in stocks:
    ...
    while start_date > ipo_date:
        ...
        url = f"https://financialmodelingprep.com/api/v3/technical_indicator/daily/{symbol}?type=rsi&period=1day&apikey={api_key}&from={from_date_str}&to={to_date}"
    ...
    if all_data:
        ...
        file_name = os.path.join(current_directory, f"{symbol}_RSI_Daily.csv")
